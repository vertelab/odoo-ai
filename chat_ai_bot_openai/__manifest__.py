...
##############################################################################
{
    'name': 'odoo-ai: Chat AI-Bot: for OpenAI',
    'version': '1.3',
    ...
    'description': """
    AI Bot for LLM-servers compatible with OpenAI/using openai-api.
    """,
    #'sequence': '1',
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-ai/chat_ai_bot_openai',
